...
urlpatterns = [
    ...
    url(r'^$', RedirectView.as_view(pattern_name='resume_list')),

    url(r'^resume_list/$', resume_views.resume_list_view, name='resume_list'),

    url(r'^resume/(\d+)/$', resume_views.resume_view, name='resume'),
